...
namespace FormExito
{
    public partial class FormVehiculos : Form
    {
        ...
        private async void CargarVehiculos()
        {
            ...
            string link = Program.UrlApi + "controlvehiculo";
            ...
            if (ControlVehiculos != null)
            {
                foreach (var controlVehiculo in ControlVehiculos)
                {
                    ...
                    Panel panelFechaFinal = new Panel
                    {
                        Width = 250,
                        BorderStyle = BorderStyle.FixedSingle,
                        Padding = new Padding(5),
                    ...
                    {
                        Text = $"{controlVehiculo.fecha_salida}",
                        AutoSize = true,
                        Font = new Font("Arial", 14),
                        Location = new Point(10, 30),
                        Dock = DockStyle.Left
                    ...
                    panelFechaFinal.Controls.Add(lblFechaFinal);
                    ...
                    panelVehiculo.Controls.Add(panelFechaFinal);
        ...
        private async void BtnVerVehiculo_Click(object sender, EventArgs e)
        {
            ...
            FormEntradaVehiculo formDetalle = new FormEntradaVehiculo(vehiculo, controlVehiculo, cliente, true);
